                ...
                <div className="card-body">
                  ...
                  <form id="login" onSubmit={handleSubmit}   encType="multipart/form-data">
                    <div className="mb-3 logfc" >
                      ...
                      <label for="exampleInputEmail1" className="form-label" placeholder='Enter email'>Email</label>
                    ...
                    <div className="mb-3">
                      ...
                      <input  placeholder='Enter Password' type="password" className="form-control" id="exampleInputPassword1" name='pwd' onChange={handleInput} />
                    </div>
